...
func TestCreateUserDeliveryServerError(t *testing.T) {
	...
	defer server.Close()
	err = client.CreateUserDeliveryServer(0, nil)
	if err == nil {
		t.Fatalf("An error should be returned")
	}
	if err.Error() != domainIDError {
	...
	err = client.CreateUserDeliveryServer(1, nil)
	if err == nil {
		t.Fatalf("An error should be returned")
	}
...
func TestCreateUserDeliveryServerOK(t *testing.T) {
	...
	err = client.CreateUserDeliveryServer(domainID, ds)
	if err != nil {
		t.Fatalf("An error should not be returned: %s", err)
	}
	if ds.ID != serverID {
...
func TestUpdateUserDeliveryServerError(t *testing.T) {
	...
	err = client.UpdateUserDeliveryServer(1, ds)
	if err == nil {
		t.Fatalf("An error should be returned")
	}
...
func TestUpdateUserDeliveryServerOK(t *testing.T) {
	...
	err = client.UpdateUserDeliveryServer(domainID, ds)
	if err != nil {
		t.Fatalf("An error should not be returned: %s", err)
	}
	if ds.ID != serverID {
...
func TestDeleteUserDeliveryServerError(t *testing.T) {
	...
	err = client.DeleteUserDeliveryServer(1, ds)
	if err == nil {
		t.Fatalf("An error should be returned")
	}
	if err.Error() != serverSIDError {
...
func TestDeleteUserDeliveryServerOK(t *testing.T) {
	...
	err = client.DeleteUserDeliveryServer(domainID, ds)
	if err != nil {
		t.Fatalf("An error should not be returned: %s", err)
	}
}
