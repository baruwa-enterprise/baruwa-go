...
var (
	...
	userAlias            *flaggy.Subcommand
	userAliasGet         *flaggy.Subcommand
	userAliasCreate      *flaggy.Subcommand
	userAliasUpdate      *flaggy.Subcommand
	userAliasDelete      *flaggy.Subcommand
...
func init() {
	...
	userAlias = flaggy.NewSubcommand("alias")
	userAlias.Description = "Alias address management"
	userAliasGet = flaggy.NewSubcommand("show")
	userAliasGet.Description = "Show alias address details"
	userAliasCreate = flaggy.NewSubcommand("create")
	userAliasCreate.Description = "Create alias address"
	userAliasUpdate = flaggy.NewSubcommand("update")
	userAliasUpdate.Description = "Update alias address"
	userAliasDelete = flaggy.NewSubcommand("delete")
	userAliasDelete.Description = "Delete alias address"
	...
	user.AttachSubcommand(userAlias, 1)
	userAlias.AttachSubcommand(userAliasGet, 1)
	userAlias.AttachSubcommand(userAliasCreate, 1)
	userAlias.AttachSubcommand(userAliasUpdate, 1)
	userAlias.AttachSubcommand(userAliasDelete, 1)
